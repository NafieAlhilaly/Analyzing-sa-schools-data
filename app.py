...
st.write("[مصدر البيانات](https://data.gov.sa/Data/tl/dataset/2014-2021)")
st.write("عينات عشوائية من جدول البيانات")
st.write(data.sample(8))
"""
------------------------------------
"""
st.write("معلومات إحصائية عن جدول البيانات")
...
"سنقوم بتغيير اسماء الأعمدة للغة الإنقليزية كالتالي :"
...
"جدول يوضح عدد الطلاب والمدارس خلال السنوات من 2014 إلى 2021"
st.write(df)
st.write(px.line(df, x=df['السنوات'], y=['عدد الطلاب','عدد المدارس']))
